...
apt-get update
apt-get install -y git curl gcc build-essential mmdebstrap zstd systemd-container xorriso squashfs-tools grub-pc-bin grub-efi-amd64-bin dosfstools dracut util-linux parted rsync qemu-system-x86 ovmf
